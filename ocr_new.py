...
def ocr_thread():
    ...
    while keep_running:
        # 截取并提取区域的数字
        number1, _ = extract_number_from_image(capture_region(region1))
        number2, _ = extract_number_from_image(capture_region(region2))
...
if __name__ == "__main__":
    ...
    keyboard.add_hotkey('esc', stop_on_esc)
